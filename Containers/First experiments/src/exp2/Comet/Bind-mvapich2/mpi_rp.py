...
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(0, n):
            ...
            #cud.pre_exec   += ['export SINGULARITYENV_PREPEND_PATH=/opt/mvapich2/intel/ib/bin/']
            #cud.pre_exec   += ['export SINGULARITYENV_LD_LIBRARY_PATH=/opt/mvapich2/intel/ib/lib/:/opt/intel/2018.1.163/lib/intel64:/etc/libibverbs.d']
            #cud.executable   = 'singularity'
            #cud.arguments    = []
            #cud.arguments   += ['exec']
            #cud.arguments   += ['--bind', '/opt/mvapich2/intel/ib/']
            #cud.arguments   += ['--bind', '/lib64']
            #cud.arguments   += ['--bind', '/opt/intel/2018.1.163/lib/intel64']
            #cud.arguments   += ['--bind', '/etc/libibverbs.d']
