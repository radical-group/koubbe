...
class OptimizationTask(Task):
    def __init__(self, name, script, hparams, results_dir):
        ...
        self.copy_input_data  += ['$SHARED/data_Sugar.npy']
...
if __name__ == '__main__':
    ...
    results_dir = '/home/karahbit/resultsAlcohol'   # dir on Comet
    cur_dir = '/home/karahbit/FastFingerPrinting/phase1/src/galloOSIOPT/hyperparams-opt/code/Neospectra' #  dir on local machine
    ...
    appman.shared_data   = []
    appman.shared_data += ['%s/data_Sugar.npy' %cur_dir]
